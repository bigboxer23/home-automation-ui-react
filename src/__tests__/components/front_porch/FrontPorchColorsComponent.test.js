...
jest.mock("../../../components/front_porch/FrontPorchColorButton", () => {
	return function MockFrontPorchColorButton(props) {
		return (
...
jest.mock("../../../components/front_porch/FrontPorchHueSceneButton", () => {
	return function MockFrontPorchHueSceneButton(props) {
		return (
