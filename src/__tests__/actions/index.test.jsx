...
describe("Actions", () => {
	...
	describe("setMeuralOn", () => {
		test("makes API call for wakeup when turning on", () => {
			...
			expect(global.fetch).toHaveBeenCalledWith(
				expect.objectContaining({
					url: "http://localhost/S/meural/wakeup",
					method: "POST",
				}),
				expect.any(Object),
			);
		...
		test("makes API call for sleep when turning off", () => {
			...
			expect(global.fetch).toHaveBeenCalledWith(
				expect.objectContaining({
					url: "http://localhost/S/meural/sleep",
					method: "POST",
				}),
				expect.any(Object),
			);
	...
	describe("nextMeuralImage", () => {
		test("makes API call for next picture", () => {
			...
			expect(global.fetch).toHaveBeenCalledWith(
				expect.objectContaining({
					url: "http://localhost/S/meural/nextPicture",
					method: "POST",
				}),
				expect.any(Object),
			);
	...
	describe("previousMeuralImage", () => {
		test("makes API call for previous picture", () => {
			...
			expect(global.fetch).toHaveBeenCalledWith(
				expect.objectContaining({
					url: "http://localhost/S/meural/prevPicture",
					method: "POST",
				}),
				expect.any(Object),
			);
	...
	describe("setMeuralSource", () => {
		test("makes API call for source change", () => {
			...
			expect(global.fetch).toHaveBeenCalledWith(
				expect.objectContaining({
					url: "http://localhost/S/meural/changeSource?source=2",
					method: "POST",
				}),
				expect.any(Object),
			);
	...
	describe("updateOpenAIQuality", () => {
		test("makes API call with quality parameter", () => {
			...
			expect(global.fetch).toHaveBeenCalledWith(
				expect.objectContaining({
					url: "http://localhost/S/meural/updateOpenAIQuality?quality=high",
					method: "POST",
				}),
				expect.any(Object),
			);
	...
	describe("updateOpenAIStyle", () => {
		test("makes API call with style parameter", () => {
			...
			expect(global.fetch).toHaveBeenCalledWith(
				expect.objectContaining({
					url: "http://localhost/S/meural/updateOpenAIStyle?style=realistic",
					method: "POST",
				}),
				expect.any(Object),
			);
	...
	describe("updateOpenAIPrompt", () => {
		test("makes API call with prompt parameter", () => {
			...
			expect(global.fetch).toHaveBeenCalledWith(
				expect.objectContaining({
					url: "http://localhost/S/meural/updateOpenAIPrompt?prompt=a%20beautiful%20sunset",
					method: "POST",
				}),
				expect.any(Object),
			);
	...
	describe("showInfo", () => {
		test("makes API call to show info", () => {
			...
			expect(global.fetch).toHaveBeenCalledWith(
				expect.objectContaining({
					url: "http://localhost/S/meural/showInfo",
					method: "POST",
				}),
				expect.any(Object),
			);
	...
	describe("hideInfo", () => {
		test("makes API call to hide info", () => {
			...
			expect(global.fetch).toHaveBeenCalledWith(
				expect.objectContaining({
					url: "http://localhost/S/meural/hideInfo",
					method: "POST",
				}),
				expect.any(Object),
			);
